...
> 移动端：微信小程序  
> 用途：前后端开发、联调、测试及部署依据  
> 本文为拟建设方案；容量、性能及时效属于规划目标，需通过试点验证。
...
开发启动时根据官方兼容关系锁定版本，不使用浮动的latest标签。短信、电话及对象存储通过适配层接入，供应商凭据使用外部配置管理。
...
- 本开发说明书、页面原型和适老化规范。
- 前后端源码、锁定依赖、数据库迁移文件。
- OpenAPI文档、状态枚举和错误码说明。
- 权限矩阵、隐私告知、授权文本和保存期限表。
- 数据处理清单、影响评估及审计整改材料。
- 功能、安全、性能和真机验收报告。
- 部署、回滚、备份恢复及值守操作手册。

本文件描述拟实施的系统设计，不代表软件已开发、外部服务已接通或合规验收已完成。
